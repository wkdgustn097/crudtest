	...
	<form action="<%=request.getContextPath()%>/updateBoardAction.jsp">
		<table border="1">
			...
			<tr>
				<th>board_title<th>
				<td>
					<input type="text" name="boardTitle" value="<%=board.boardTitle%>"> <!-- 원래 값 보여주기 -->
				</td>
			</tr>
			<tr>
				<th>board_contents<th>
				<td>
					<textarea rows="5" cols="33" name="boardContents"><%=board.boardContents%></textarea> <!-- 원래 값 보여주기 -->
				</td>
			</tr>
			<tr>
				<th>board_writer<th>
				<td>
					<input type="text" name="boardWriter" value="<%=board.boardWriter%>"> <!-- 원래 값 보여주기 -->
				</td>
			</tr>
			<tr>
				<th>board_pw<th>
